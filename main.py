...
def inserted_text():
    user_input = TextField.get("1.0", END).strip().lower()
    ...
    if "hello" in user_input:
    ...
    elif "how can subscription services reduce churn rates" in user_input:
        TextField2.insert(END, "Providing personalized experiences, engaging with customers, and offering loyalty rewards can help maintain subscriptions.\n \n")

    elif "what marketing tactics work well for subscription box launches" in user_input:
        TextField2.insert(END, "Collaborating with influencers, running giveaways, and utilizing email marketing can enerate interest. \n \n")
        ...
        TextField2.insert(END, "Sorry that question has not been inputed in my DataBase\n \n")
        TextField.delete("1.0", END)
